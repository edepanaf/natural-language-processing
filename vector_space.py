...
class VectorSpace:
    ...
    def __init__(self, bags):
        self.item_to_index = map_to_index_from_bag(iterables_union(bags))
        self.bag_to_index = map_to_index_from_bag(bags)
    ...
    def bag_vector_from_collection(self, bags):
        distribution_on_bags = constant_distribution_from_collection(bags)
